...
Dominique Cardon, **'A quoi rêvent les algorithmes: Nos vies à l'heure des big data'**, 2015, `asin: B0158V34NA` `@home`

Olivier Botar,  **'Sensing the Future: Moholy-Nagy'**, Media and the Arts

Stéphane Vial, **'L'être et l'écran'**, 2013, `@home`
...
Alan Turing, **'Computing Machinery and Intelligence'**, 1950, `asin: B0007KFTH2` `@BPI: 510.1 TUR` `@PDF`

Edgar Morin, **`Introduction à la pensée complexe`**, 2005, `@home`

Ludwig Wittgenstein, **'Tractacus Logico-Philosophicus'**, `isbn:978-1602064515` `@BPI: 1"4" WITT 2` `@PDF`
